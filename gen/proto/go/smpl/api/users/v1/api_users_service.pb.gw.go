...
func RegisterUsersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UsersServiceServer) error {
	...
	mux.Handle("POST", pattern_UsersService_CreateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/smpl.api.users.v1.UsersService/CreateUser", runtime.WithHTTPPathPattern("/api/v1/users"))
		if err != nil {
		...
		forward_UsersService_CreateUser_0(ctx, mux, outboundMarshaler, w, req, response_UsersService_CreateUser_0{resp}, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_UsersService_ListUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/smpl.api.users.v1.UsersService/ListUsers", runtime.WithHTTPPathPattern("/api/v1/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_UsersService_ListUsers_0(ctx, mux, outboundMarshaler, w, req, response_UsersService_ListUsers_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterUsersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UsersServiceClient) error {
	...
	mux.Handle("POST", pattern_UsersService_CreateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/smpl.api.users.v1.UsersService/CreateUser", runtime.WithHTTPPathPattern("/api/v1/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_UsersService_ListUsers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/smpl.api.users.v1.UsersService/ListUsers", runtime.WithHTTPPathPattern("/api/v1/users"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_UsersService_CreateUser_0 struct {
	proto.Message
}

func (m response_UsersService_CreateUser_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateUserResponse)
	return response.User
}

type response_UsersService_ListUsers_0 struct {
	proto.Message
}

func (m response_UsersService_ListUsers_0) XXX_ResponseBody() interface{} {
